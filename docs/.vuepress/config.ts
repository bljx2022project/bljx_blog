  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        text: '快速链接',
        items: [
          { text: '北京林业大学', link: 'http://www.bjfu.edu.cn/' },
          { text: '信息学院', link: 'http://it.bjfu.edu.cn/' },
    ...
    footer: {
      ...
      copyrightInfo:
        '<br><img style="margin:0 auto;height:50px;" src="/img/minilogo.png"/><br>北林计协 | Made with ❤ by czh.<br>MIT LICENSE | Build with <a href="https://vuepress.vuejs.org/zh/">vuepress<a>.<br>Powered by <a href="https://www.netlify.com/">Netlify</a>.', // 博客版权信息，支持a标签或换行标签</br>
    },
